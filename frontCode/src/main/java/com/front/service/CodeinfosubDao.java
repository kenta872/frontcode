...
public class CodeinfosubDao {
	...
	public CodeinfosubEntity searchSrcByPostid(Integer postid, String codegenre) throws Exception {
		...
		Query Query = entityManager
				.createQuery("from CodeinfosubEntity where codegenre = '" + codegenre + "' and postid = " + postid);
	...
	public String findCodeByPostid(Integer postid, String codeType) {
		...
		Query codeinfoQuery = entityManager.createQuery(
				"select src from CodeinfosubEntity where codegenre = '" + codeType + "' and postid = " + postid);
